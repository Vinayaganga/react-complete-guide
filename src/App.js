    ...
    setPersonsState({
      ...
      return (
        <div className="App">
          ...
          <Person name={personsState.persons[1].name} age={personsState.persons[1].age} click={switchNameHandler.bind(this,'Vinaya Ashwin!')}>My Hobbies: Computer Games</Person>
